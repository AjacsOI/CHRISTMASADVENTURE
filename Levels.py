...
class FirstLevel(Level):
    '''Первый уровень
     Имеет 5 шипов, 1 выход, 4 границы, 8 кирпичей.
     Сложность - легко

    Аргументы инициализации:
         *settings - Взаимодействует с настройками из настроек класса: dict
         *hit_points — количество жизней игрока: int

    Методы:
         *get_sprites — Загрузка объектов уровня.
    '''
    __slots__ = []
...
class SecondLevel(Level):
    '''Второй уровень
     Имеет 7 шипов, 1 выход, 4 границы, 21 кирпич, 1 шип 5x, 1 вулкан.
...
class ThirdLevel(Level):
    '''Третий уровень
     Имеет 12 шипов, 1 выход, 4 границы, 71 кирпич, 1 вулкан, 1 бензопилу.
     Сложность - сложно
     ...
     Методы:
         *get_sprites — Загрузка объектов уровня.
         *game_cycle - Игровой цикл с эффектом слепоты
    '''
    __slots__ = []
...
class FourthLevel(Level):
    '''Четвертый уровень
     ...
     Методы:
         *get_sprites — Загрузка объектов уровня.
         *in_allowed_zone - Проверить, может ли игрок поставить брейк или нет
         *event_handler — Обработка событий, сборка кубиков игроков.
    '''
    __slots__ = ['bricks']
...
class FifthLevel(Level):
    '''Пятый уровень
     Имеет 16 шипов, 1 выход, 8 кирпичей, 4 шипа 5x, 1 перчатку.
     Сложность - сложно
